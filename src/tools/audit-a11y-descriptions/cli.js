...
const HELP_TEXT = `
Usage: figma-audit-a11y-descriptions [options]

Audits interactive component descriptions for accessibility documentation quality.
Checks whether descriptions mention keyboard behavior, ARIA roles, focus management,
or other accessibility-relevant information.
...
async function main() {
  try {
    ...
    const report = await auditA11yDescriptionCoverage(config)
