...
const HELP_TEXT = `
Usage: figma-audit-a11y-target-sizes [options]

Audits interactive components for WCAG 2.5.8 target size compliance (24×24px minimum).
...
async function main() {
  try {
    ...
    const report = await auditA11yTargetSizes(config)
