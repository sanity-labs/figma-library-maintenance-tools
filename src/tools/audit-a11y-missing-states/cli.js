...
const HELP_TEXT = `
Usage: figma-audit-a11y-states [options]

Audits interactive components for missing state variants (focused, disabled, invalid, readOnly).
...
async function main() {
  try {
    ...
    const report = await auditA11yMissingStates(config)
